  ...
  return (
    <>
      <Menu as="div" className="relative inline-flex">
        {({ open }) => (
          <>
            <Menu.Button className="px-4 py-2 btn flex justify-between items-center min-w-[18rem] bg-hlinoteka-gray text-hlinoteka-light hover:text-hlinoteka-active rounded-2xl">
              <span className="flex">
                  ...
                  <Menu.Item key={optionIndex}>
                    {({ active }) => (
                      <Link
                        ...
                        className={`flex items-center w-full py-1 px-3 cursor-pointer ${active ? "bg-hlinoteka-inactive" : ""} ${
                          option.id === selectedOption && "text-hlinoteka-active"
                        }`}
                        onClick={() => {
                      ...
                      >
                        <svg
                          className={`shrink-0 mr-2 fill-current text-hlinoteka-active ${option.id !== selectedOption && "invisible"}`}
                          width="12"
                          height="9"
                          viewBox="0 0 12 9"
                        >
                    ...
                    <Menu.Item key={authorIndex}>
                      {({ active }) => (
                        <Link
                          ...
                          className={`flex items-center w-full py-1 px-3 cursor-pointer ${active ? "bg-hlinoteka-inactive" : ""} ${
                            author === selectedAuthor && "text-hlinoteka-active"
                          }`}
                          onClick={() => {
                        ...
                        >
                          <svg
                            className={`shrink-0 mr-2 fill-current text-hlinoteka-active ${author !== selectedAuthor && "invisible"}`}
                            width="12"
                            height="9"
                            viewBox="0 0 12 9"
                          >
                    ...
                    <Menu.Item key={tagIndex}>
                      {({ active }) => (
                        <Link
                          ...
                          className={`flex items-center w-full py-1 px-3 cursor-pointer ${active ? "bg-hlinoteka-inactive" : ""} ${
                            tag._id === selectedTag._id && "text-hlinoteka-active"
                          }`}
                          onClick={() => {
                            setSelectedTag(tag);
                          }}
                        >
                          <svg
                            className={`shrink-0 mr-2 fill-current text-hlinoteka-active ${tag._id !== selectedTag._id && "invisible"}`}
                            width="12"
                            height="9"
                            viewBox="0 0 12 9"
                          >
